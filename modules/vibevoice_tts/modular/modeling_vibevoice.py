...
class VibeVoiceModel(VibeVoicePreTrainedModel):
    def __init__(self, config):
        ...
        # Use 'dtype' parameter instead of deprecated 'torch_dtype' in config
        lm_dtype = lm_config.torch_dtype if hasattr(lm_config, 'torch_dtype') and lm_config.torch_dtype is not None else dtype
        self.language_model = AutoModel.from_config(lm_config, dtype=lm_dtype)
